const CACHE_NAME = 'formommy-v11';
const CORE = [
  './', './index.html', './styles.css?v=11', './module-ui.css?v=11',
  './course-data.js?v=11', './app.js?v=11', './module-ui.js?v=11', './quick-practice.js?v=11',
  './manifest.webmanifest?v=11', './favicon.svg'
];
